...
if (isset($_POST['save'])) {
    ...
    if (isset($_FILES['pdf']) && $_FILES['pdf']['error'] == 0) {
        ...
        if (move_uploaded_file($file_tmp, $file_path)) {
            ...
            $sql = "UPDATE books SET title='$title', isbn='$isbn', file='$pdf_path', publish_date='$date', author_id='$author_id', book_category_id='$category_id' WHERE books.id='$bid';";
        ...
        $response = "No file uploaded or file upload error.";
    }

}

?>
<?php if (isAdmin()  && isset($_GET['bid'])) { ?>
...
<?php 
    ...
    $sql = "SELECT books.id AS book_id, books.title, books.publish_date, books.isbn, authors.id AS author_id, authors.name AS author_name,
    book_categories.id AS category_id, book_categories.name AS category_name FROM books JOIN authors ON books.author_id =
    authors.id JOIN book_categories ON books.book_category_id = book_categories.id WHERE books.id='$bid';";
                            ...
                            <div class="overflow-x-auto">
                                <div class="inline-block w-full align-middle">
                                    <div class="overflow-hidden shadow px-4">
                                        ...
                                        <?php if ($result->num_rows > 0) { $book = $result->fetch_assoc(); ?>
                                        ...
                                        <?php }else{echo "No Book with that ID";} ?>
