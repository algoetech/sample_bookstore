...
if (isset($_POST['save'])) {
    ...
    $sql = "INSERT INTO book_categories (name) VALUES ('$cate');";

    if ($conn->query($sql) === TRUE) {
        $response = "<p>Category added successfully!</p>";
    } else {
...
<?php 
    ...
    FROM 
        book_categories
    LEFT JOIN 
        books ON book_categories.id = books.book_category_id
    GROUP BY 
        book_categories.id, book_categories.name";
                    ...
                    <div class="flex flex-col pt-3 px-5">
                                ...
                                <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                                    ...
                                    <li>
                                        <div class="flex items-center">
                                            ...
                                            <a href="#"
                                                class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-primary-500">Categories</a>
                                        </div>
                                    </li>
                        ...
                        <div class="sm:flex">
                            ...
                            <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                                <button type="button" id="toggleButton" data-model="Category"
                                    ...
                                    <span id="buttonText">Add Category</span>
                                </button>
                            ...
                            <div class="overflow-x-auto">
                                <div class="inline-block w-full align-middle">
                                    <div class="overflow-hidden shadow px-4">
                                        ...
                                        <?php }else{echo "No Category added yet";} ?>
                                        ...
                                        <form action="" class="add hidden" id="add" method="POST">
                                            ...
                                            <button type="submit" name="save"
                                                class="text-white relative w-full hover:bg-gradient-to-tl hover:from-vendor-secondary-beta hover:via-vendor-secondary-alpha hover:to-vendor-tertiary-beta transition-none ease-soft-in-out hover:scale-[102%] bg-gradient-cyan my-4 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm  px-5 py-2.5 text-center ">Save</button>
