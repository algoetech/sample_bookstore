...
<?php
    ...
    $metrix = $conn->prepare("SELECT 
        (SELECT COUNT(*) FROM users) AS tusers,
   ...
   $count = '';
    try { 
        $metrix->execute();
        $metrix->bind_result($tusers, $tbooks, $tcates, $treqs);
        $count = $metrix->fetch();
        // var_dump($tbooks);
                ...
                <main>
                    ...
                    <div class="grid grid-cols-1 px-4 pt-6 xl:grid-cols-3 xl:gap-4 dark:bg-gray-900">
                        ...
                        <div class="col-span-full flex gap-2 min-w-full">
                            <div class="p-4 mb-4 space-y-6 bg-white border border-gray-200 rounded-lg shadow-sm col-span-4 w-25 dark:border-gray-700 sm:p-6 dark:bg-gray-800"
                                style="max-width: 24%">
                                <div
