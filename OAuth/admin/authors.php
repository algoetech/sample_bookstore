...
if (isset($_POST['save'])) {
   ...
   try {
    if (is_null($user) || $user=="") {
        echo "top";
        $insert = $conn->prepare("INSERT INTO authors (name, bio, birth_date) VALUES ('$name', '$bio', '$birth');");
        $insert->execute();
        $response = 'Author created successfully!';
    }else {
        $insert = $conn->prepare("INSERT INTO authors (name, user_id, bio, birth_date) VALUES ('$name', '$user', '$bio', '$birth');");
        $insert->execute();
        $response = 'Author created successfully!';
    }
...
if(isset($_POST['delete'])){
    ...
    $sql = $conn->prepare("DELETE FROM authors WHERE authors.id='$deleteId';");
    $sql->execute();
                ...
                <main>
                    ...
                    <div class="flex flex-col pt-3 px-5">
                        <div class="mb-4 col-span-full xl:mb-2">
                            ...
                            <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Authors</h1>
                        </div>
                        <!-- Right Content -->
                        ...
                        <div class="sm:flex">
                            ...
                            <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                                <button type="button" id="toggleButton" data-model="Author"
                            ...
                            <div class="overflow-x-auto">
                                <div class="inline-block w-full align-middle">
                                    <div class="overflow-hidden shadow px-4">
                                                ...
                                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                                    ...
                                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                                        ...
                                                        <form action="" method="POST" id="deleteForm">
                                                            <input type="hidden" name="daid" id="delete"
                                        ...
                                        <?php }else{echo "No Author added yet";} ?>
                                        ...
                                        <form action="" class="add hidden" id="add" method="POST"
                                            ...
                                            <div class="col-span-6 sm:col-span-3">
                                                ...
                                                <input type="text" name="bio" id="isbn"
                                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                    placeholder="The leader" required="">
                                            </div>
                                            <div class="col-span-6 sm:col-span-3">
                                                <label for="first-name"
                                            ...
                                            <div class="col-span-6 sm:col-span-3">
                                                <label for="first-name"
                                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">As
                                                    User</label>
                                                <select name="user" id="author"
                                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                    placeholder="Science">
                                                    <option value="">----</option>
                                                    <?php 
            
                                                    $cates = "SELECT * FROM users";
                                                    $rez = $conn->query($cates);
                                                    while($cate = $rez->fetch_assoc()){
                                                    ?>
                                                    <option value="<?php echo $cate['id']; ?>">
                                                        <?php echo $cate['username']; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
