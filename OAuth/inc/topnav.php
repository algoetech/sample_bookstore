        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="index.php" class=" flex ml-2 md:mr-24">
                    <img src="https://flowbite-admin-dashboard.vercel.app/images/logo.svg" class="h-8 mr-3"
                        alt="FlowBite Logo">
                    <span
                        class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">BookStore</span>
                </a>
            ...
            <div class="flex items-center">
                ...
                <div id="tooltip-toggle" role="tooltip"
                    ...
                    style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(902.667px, 66.6667px, 0px);"
                    data-popper-placement="bottom">
                    Toggling dark mode
                    <div class="tooltip-arrow" data-popper-arrow=""
                        style="position: absolute; left: 0px; transform: translate3d(79.3333px, 0px, 0px);">
                    </div>
                </div>
                ...
                <div class="flex items-center ml-3">
                    ...
                    <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                        id="dropdown-2"
                        style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(1034px, 62.6667px, 0px);"
                        data-popper-placement="bottom">
